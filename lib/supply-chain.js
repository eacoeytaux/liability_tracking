 ...
 * @param {org.acme.supply-chain.TransferLiability} transfer - the liability of the resource to be processed
 * @transaction
 */
function takeLiability(transfer) {
	transfer.resourceLiability.owner = trade.newOwner;
	return getAssetRegistry('org.acme.supply-chain.ResourceLiability')
